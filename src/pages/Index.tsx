      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-20">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-cyan-600 hover:bg-cyan-700 text-white px-8 py-4 rounded-lg font-semibold transition-all transform hover:scale-105">
              Start Exploring
            </button>
            <button className="border border-slate-600 text-slate-300 hover:text-white hover:border-cyan-500 px-8 py-4 rounded-lg font-semibold transition-all">
              Learn More
            </button>
          </div>
        </div>
      ...
      <section className="py-16 bg-slate-800/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">Why Yanbu Vibes?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-slate-800/50 rounded-xl border border-slate-700 hover:border-cyan-500/50 transition-all">
              ...
              <p className="text-slate-300">Discover places around you with real-time crowd levels and gender ratios</p>
            </div>
            ...
            <div className="text-center p-6 bg-slate-800/50 rounded-xl border border-slate-700 hover:border-cyan-500/50 transition-all">
              ...
              <p className="text-slate-300">Join anonymous group chats when you're within 500m of any location</p>
            </div>
            ...
            <div className="text-center p-6 bg-slate-800/50 rounded-xl border border-slate-700 hover:border-cyan-500/50 transition-all">
              ...
              <p className="text-slate-300">Discover and join exciting events happening around Yanbu</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-white">Yanbu Vibes</h3>
              </div>
              <p className="text-slate-300 mb-4">
                Connecting Yanbu's community through location-based social experiences
              </p>
              <p className="text-slate-400 text-sm">
                © 2024 Yanbu Vibes. All rights reserved.
              </p>
            </div>
