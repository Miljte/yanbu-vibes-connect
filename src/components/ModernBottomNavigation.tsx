...
import { Home, Grid3X3, Calendar, MessageSquare, User, MoreHorizontal } from 'lucide-react';
...
const ModernBottomNavigation = ({ activeSection, onSectionChange }: ModernBottomNavigationProps) => {
  ...
  return (
    <div className={`fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-lg border-t border-gray-200 z-50 ${isRTL ? 'rtl' : 'ltr'}`}>
